...
const { getInstagramPostsByUser } = require("../controllers/instagram/functions");
...
router.get("/users/:userId/scheduled", postController.getScheduledPostsByUser);
router.get("/instagram/:userId", getInstagramPostsByUser);
