...
// Importation du CSS de react-toastify
    ...
    const publierMaintenant = async () => {
        ...
        try {
            ...
            if (response.data) {
                ...
                // Afficher une notification Toast ici
                toast.success("Tweet publié avec succès !", {
                    position: "bottom-right", // Position de l'alerte
                    autoClose: 5000, // Durée de l'alerte
                    hideProgressBar: true, // Masquer la barre de progression
                    closeOnClick: true, // Permet de fermer la notification au clic
                    pauseOnHover: true, // Pause si l'utilisateur survole la notification
                });
            }
    ...
    const planifierPublication = async () => {
        ...
        try {
            ...
            if (response.data) {
                ...
                toast.success("Tweet planifié avec succès !", {
                    position: "bottom-right",
                    autoClose: 5000,
                    hideProgressBar: true,
                    closeOnClick: true,
            ...
            <div className="ml-64 mt-16">
                <div className="flex bg-gray-100 h-screen">
                    <div className="w-full max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-lg">
                        ...
                        <select
                            id="publish-select"
                            className="bg-[#FF0035] hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-md w-full mt-4"
                            value={action}
                        ...
                        <button
                            ...
                            className="mt-6 w-full bg-[#FF0035] hover:bg-red-700 text-white py-3 rounded-lg shadow-md"
                        >
                            Publier
                        </button>
                    </div>
